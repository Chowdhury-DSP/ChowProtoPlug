...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    declare -a plugins=("build/ChowProtoPlug_artefacts/VST3/ChowProtoPlug.vst3")
else
    pluginval=$(install_pluginval_win)
    declare -a plugins=("build/ChowProtoPlug_artefacts/Release/VST3/ChowProtoPlug.vst3")
fi
