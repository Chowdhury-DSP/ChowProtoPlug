...
mkdir -p bin/Win64
mkdir -p bin/Win32
declare -a plugins=("ChowProtoPlug")
...
(
    cd bin
    rm -f "ChowProtoPlug-Win64-${VERSION}.zip"
    zip -r "ChowProtoPlug-Win64-${VERSION}.zip" Win64
    # rm -f "ChowProtoPlug-Win32-${VERSION}.zip"
    # zip -r "ChowProtoPlug-Win32-${VERSION}.zip" Win32
)
